...
export function HeroSection() {
  return (
    <section className="relative overflow-hidden bg-gradient-to-br from-background via-background to-muted/40 py-12 md:py-20">
      ...
      <div className="container relative mx-auto px-4 text-center">
        <div className="mx-auto max-w-4xl space-y-5">
          ...
          <div className="flex flex-col gap-3 sm:flex-row sm:justify-center">
            <Link
              href="#tools"
              className={buttonVariants({ size: "lg", className: "text-sm h-11 px-7" })}
            >
            ...
            <Link
              href="#tools"
              className={buttonVariants({ size: "lg", variant: "outline", className: "text-sm h-11 px-7" })}
            >
              Browse All Tools
            </Link>
          </div>
          ...
          {/* Trust badges */}
          <div className="flex flex-wrap items-center justify-center gap-5 pt-4 text-sm text-muted-foreground">
