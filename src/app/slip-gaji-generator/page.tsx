...
export default function SlipGajiGeneratorPage() {
  ...
  const generatePdf = async () => {
    ...
    if (profile.phone) {
      page.drawText(`Phone: ${profile.phone}`, { x: 50, y, size: 10, font, color: colors.lightText });
      y -= 15;
    }
    if (profile.email) {
      page.drawText(`Email: ${profile.email}`, { x: 50, y, size: 10, font, color: colors.lightText });
      y -= 15;
    }
